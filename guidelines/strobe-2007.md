...
version: "2007"
applies_to: Observational studies — cohort, case-control, and cross-sectional
items: 22
sections: 7
...
22 items. This is the combined checklist covering all three designs. Items marked with an asterisk (8*, 13*, 14*, 15*, 16*, 17*) require information to be given separately for cases and controls in case-control studies, and where applicable for exposed and unexposed groups in cohort and cross-sectional studies. Design-specific versions exist and are noted in INVENTORY.md.

Cite as `[@vonelm2007strobe]`.
