...
items: 21
structure: "Essential 10 (items 1-10) = minimum for assessing reliability; Recommended Set (items 11-21) = context, best practice"
...
21 items, split into two tiers. Unlike most guidelines here, ARRIVE 2.0 is explicitly
prioritised:

- **The Essential 10** (items 1–10) are the basic minimum. Without them, readers and
  reviewers cannot assess the reliability of the findings.
- **The Recommended Set** (items 11–21) adds important context. Reporting both sets
  represents best practice.

Cite as `[@perciedusert2020arrive]`. A separate Explanation and Elaboration document
(doi:10.1371/journal.pbio.3000411) gives the rationale and worked examples for each item.
...
- a. Interpret the results, taking into account the study objectives and hypotheses, current scientific theory and other relevant studies in the literature.
...
- a. Declare any potential conflicts of interest, including financial and non-financial. If none exist, this should be stated.
