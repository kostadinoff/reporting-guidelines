...
version: "2.0 (2015)"
supersedes: SQUIRE 1.0
applies_to: Reports of system-level work to improve the quality, safety, and value of healthcare
items: 18
...
18 items for reporting system-level quality-improvement work. Unlike most guidelines here,
SQUIRE is deliberately permissive: authors should consider every item, but including every
element may be inappropriate or unnecessary in a given manuscript.

Intended for reports that describe system-level work to improve quality, safety, or value
**and** used methods to establish that observed outcomes were due to the intervention(s).

Cite as `[@ogrinc2016squire]`. A Glossary and an Explanation and Elaboration document
accompany the checklist at the official site.
...
### Item 3 — Problem description

Nature and significance of the local problem.

### Item 4 — Available knowledge
...
### Item 12 — Ethical considerations
