...
applies_to: Randomised controlled trials — the primary report of results
items: 30
item_blocks: 42  # numbered items expand into sub-item blocks (3a, 3b, ...)
sections: 7
citation_key: hopewell2025consort
...
Third update since 1996 (previous: 2001, 2010). Adds seven new items, revises three, removes one, and introduces an Open science section (items 2-5b). Harmonised with SPIRIT 2025 and published simultaneously in BMJ, JAMA, Lancet, Nature Medicine and PLOS Medicine; the PLOS Medicine version is `[@hopewell2025consortplos]`.

Cite as `[@hopewell2025consort]`.

## Title and abstract


### Item 1a — Title and structured abstract
...
### Item 5a — Funding and conflicts of interest
...
### Item 6 — Background and rationale
...
### Item 8 — Patient and public involvement
...
### Item 10 — Changes to trial protocol
...
### Item 13 — Intervention and comparator
...
### Item 18 — Allocation concealment mechanism
...
### Item 22a — Participant flow, including flow diagram
...
### Item 24a — Intervention and comparator delivery
...
### Item 26 — Numbers analysed, outcomes and estimation
...
### Item 28 — Ancillary analyses

Any other analyses performed, including subgroup and sensitivity analyses, distinguishing pre-specified from post-hoc

## Discussion


### Item 29 — Interpretation
