---
name: PRISMA-P
full_name: Preferred Reporting Items for Systematic review and Meta-Analysis Protocols
version: "2015"
applies_to: Protocols for systematic reviews and meta-analyses
items: 17
item_blocks: 26  # numbered items expand into sub-item blocks (1a, 1b, ...)
parent: prisma-2020
...
17 items for a systematic review **protocol** — the protocol counterpart to PRISMA 2020,
as SPIRIT 2025 is to CONSORT 2025. Item 2 expects registration details (PROSPERO or
equivalent).

Cite as `[@moher2015prismap]`.
...
### Item 5c — Role of Sponsor or Funder
...
- Provide an explicit statement of the question
- (s) the review will address with reference to participants, interventions, comparators, and outcomes (PICO)
...
- (s) that will be used to manage records and data throughout the review
